...
public class Login {
    ...
    public Login() {
        ...
        MiniPanel.setBackground(Color.lightGray);
        ...
        Image_jLabel.setMinimumSize(new Dimension(953, 536));
        Image_jLabel.setIcon(new ImageIcon("lp3.jpg"));
    ...
    private class LoginActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            switch (e.getActionCommand()) {
                ...
                case "Login": {
                    if (UN_TextField.getText().trim().equalsIgnoreCase("swarna")
                            && String.valueOf(Password_Field.getPassword()).equals("swarna")) {
