...
public class Booking_Details {
    ...
    public Booking_Details() {
        ...
        MainPanel.setMinimumSize(new Dimension(1000, 730));
...
//ID,  Maker,  Name,  Colour,  Type,  SeatingCapacity,  Model,  Condition,  RegNo, RentPerHour,  IsRented RentDate, carOwner customer
        ...
        String[] columns = {"Srno.", "ID", "Customer ID+Name", "Car Name", "Rent Time", "Return Time"};
...
//RentPerHour,  IsRented RentDate, carOwner customer
        ...
        jTable1.getColumnModel().getColumn(5).setMinWidth(210);

        jTable1.getTableHeader().setReorderingAllowed(false);

        MainPanel.add(jScrollPane1, new AbsoluteConstraints(10, 60, 1330, 550));
        MainPanel.add(BackButton, new AbsoluteConstraints(1020, 625, 100, 22));
        MainPanel.add(LogoutButton, new AbsoluteConstraints(1150, 625, 100, 22));
