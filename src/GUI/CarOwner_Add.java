...
public class CarOwner_Add {
    ...
    public CarOwner_Add() {
        ...
        CNIC_Label = new JLabel("Enter Adhar Number (no spaces)");
        Name_Label = new JLabel("Enter Name");
        Contact_Label = new JLabel("Enter Contact (with 91)");
        ...
        CNIC_Label.setPreferredSize(new Dimension(190, 22));
        Name_Label.setPreferredSize(new Dimension(175, 22));
        Contact_Label.setPreferredSize(new Dimension(190, 22));
        ...
        frame.add(CNIC_TextField, new AbsoluteConstraints(205, 5));
        frame.add(CNICValidity_Label, new AbsoluteConstraints(195, 30));

        frame.add(Name_Label, new AbsoluteConstraints(10, 42));
        frame.add(Name_TextField, new AbsoluteConstraints(205, 42));
        frame.add(NameValidity_Label, new AbsoluteConstraints(195, 66));

        frame.add(Contact_Label, new AbsoluteConstraints(10, 77));
        frame.add(Contact_TextField, new AbsoluteConstraints(205, 77));
        frame.add(contactValidity_Label, new AbsoluteConstraints(195, 102));

        frame.add(Add_Button, new AbsoluteConstraints(100, 155, 100, 22));
        frame.add(Cancel_Button, new AbsoluteConstraints(250, 155, 100, 22));
